    ...
    return (
        <PhoneLayout background={background}> 
            ...
            <div className="grid grid-cols-5 gap-4 mt-10 px-6">
                ...
                <Aplication color="#FF9800" color2="#F57C00" icon="✉️" name="Mensajes" to="Mensajes" />
                <Aplication color="#9C27B0" color2="#7B1FA2" icon="📷" name="Cámara" to="Camara" />
                <Aplication color="#607D8B" color2="#455A64" icon="🎨" name="Fondos" to="Fondos" />
            </div>
        </PhoneLayout>
    )
}
